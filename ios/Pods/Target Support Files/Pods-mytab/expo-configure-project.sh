...
with_node \
  ...
  --platform "apple" \
  --packages "burnt" "expo-apple-authentication" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-system-ui" "expo-web-browser"
